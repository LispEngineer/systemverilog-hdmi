...
# ACDS 21.1 842 win32 2022.02.14.23:41:02
...
# ----------------------------------------
# If pll50to148 is one of several IP cores in your
...
TOP_LEVEL_NAME="pll50to148"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="C:/bin/fpga/intelfpga_lite/21.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll50to148.vo"
fi
